...
public class StartScreenController : MonoBehaviour
{
    ...
    [Header("Scene Names")]
    [SerializeField] private string homeSceneName = "BaseScene";
    ...
    {
        var path = Path.Combine(Application.persistentDataPath, "Import", "backup.mogumogu");
        var imported = SaveManager.ImportBackup(path);
